...
angular.module('metadata', ['ui.event', 'metadata.controllers', 'metadata.directives','elasticjs.service','ui.bootstrap','$strap.directives','bootstrap']).
  config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider.when('/details/:frame/:id', {templateUrl: 'partials/new.html', controller: 'details'});
	$routeProvider.when('/new', {templateUrl: 'partials/new.html', controller: 'new'});
